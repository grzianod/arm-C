...
uint32_t init_timer ( uint8_t timer_num, uint32_t TimerInterval, uint32_t TimerInterval1 )
{
  switch(timer_num) {
		case 0: LPC_TIM0->MR0 = TimerInterval;
...
//*** <<< end of configuration section >>>    ***
			...
			NVIC_SetPriority(TIMER0_IRQn, 5);		/* more priority than buttons */
			break;
		case 1:
